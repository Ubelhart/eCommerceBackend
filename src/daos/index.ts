...
switch (process.env.DB) {
    case 'mariaSql':
        import('./carts/Sqlite3DaoCarts').then(
            ({ default: Sqlite3DaoCarts }) => {
    ...
    case 'mongoDb':
        import('./carts/MongoDbDaoCarts').then(
            ({ default: MongoDbDaoCarts }) => {
    ...
    case 'firebase':
        import('./carts/FirebaseDaoCarts').then(
            ({ default: FirebaseDaoCarts }) => {
